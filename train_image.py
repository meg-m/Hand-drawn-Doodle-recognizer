'''
Matlab format of EMNIST dataset can be downloaded from https://www.nist.gov/itl/iad/image-group/emnist-dataset
Paste the file emnist-letters.mat in matlab folder
'''
